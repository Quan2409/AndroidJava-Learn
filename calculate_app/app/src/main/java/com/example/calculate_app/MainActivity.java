...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener {
    ...
    private void initializeViewVariables() {
        ...
        textViewInputNumbers = (TextView) findViewById(R.id.input_value);
    }
    ...
    {
        boolean done = false;
        int opeationLength = textViewInputNumbers.getText().length();
        if (opeationLength > 0) {
            String lastInput = textViewInputNumbers.getText().charAt(opeationLength - 1) + "";
